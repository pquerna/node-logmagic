...
exports.registerSink = function(sink) {
  known_sinks[sink.name] = sink;
...
exports.setSinkOptions = function(name, options) {
  known_sinks[name].setOptions(options);
};

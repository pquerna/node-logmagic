...
module.exports.EMERG = 0;    /* system is unusable */
module.exports.ALERT = 1;    /* action must be taken immediately */
module.exports.CRIT = 2;     /* critical conditions */
...
module.exports.INFO = 6;     /* informational */
module.exports.DEBUG = 7;    /* debug-level messages */
module.exports.TRACE1 = 8;   /* trace-level 1 messages */
module.exports.TRACE2 = 9;   /* trace-level 2 messages */
module.exports.TRACE3 = 10;  /* trace-level 3 messages */
module.exports.TRACE4 = 11;  /* trace-level 4 messages */
module.exports.TRACE5 = 12;  /* trace-level 5 messages */
module.exports.TRACE6 = 13;  /* trace-level 6 messages */
module.exports.TRACE7 = 14;  /* trace-level 7 messages */
module.exports.TRACE8 = 15;  /* trace-level 8 messages */
...
function buildLogMethod(modulename, level, callback) {
  if (level >= module.exports.TRACE1) {
...
module.exports.local = function(modulename) {
...
module.exports.registerSink = function(sinkname, callback) {
  known_sinks[sinkname] = callback;
};

module.exports.route = function(match, loglevel, sinkname) {

  if (!(loglevel >= module.exports.EMERG && loglevel <= module.exports.TRACE8)) {
...
module.exports.addRewriter = function(func) {
  rewriters.push(func);
};

module.exports.clearRewriter = function(func) {
  rewriters.pop(func);
};
